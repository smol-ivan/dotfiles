...
-- Mapear Ctrl+h, Ctrl+j, Ctrl+k, Ctrl+l para mover el cursor en modo insertar
vim.api.nvim_set_keymap("i", "<C-h>", "<Left>", { noremap = true, silent = true })
vim.api.nvim_set_keymap("i", "<C-l>", "<Right>", { noremap = true, silent = true })
vim.api.nvim_set_keymap("i", "<C-b>", "<Down>", { noremap = true, silent = true })
vim.api.nvim_set_keymap("i", "<C-f>", "<Up>", { noremap = true, silent = true })

-- Otros movimientos estilo Emacs
